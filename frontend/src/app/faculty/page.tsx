  ...
  return (
    <>
      ...
      <main className="flex-1 bg-white font-sans text-slate-900">
        ...
        {/* --- HERO SECTION --- */}
        <section className="relative pt-24 pb-20 border-b border-slate-100 bg-white bg-cover bg-center" style={{ backgroundImage: "linear-gradient(rgba(255,255,255,0.85), rgba(255,255,255,0.85)), url('/ahmad.png')", backgroundSize: "cover", backgroundPosition: "center" }}>

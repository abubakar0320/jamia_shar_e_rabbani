...
export default function RollNumberSlipPage() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/public/student-search', {
        method: 'POST',
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 flex flex-col">
      ...
      {!student && (
        <section className="relative pt-24 pb-20 bg-slate-50 border-b border-slate-200 print:hidden bg-cover bg-center" style={{ backgroundImage: "linear-gradient(rgba(255,255,255,0.85), rgba(255,255,255,0.85)), url('/ahmad.png')", backgroundSize: "cover", backgroundPosition: "center" }}>

...
if (!serverCode.includes('/api/admin/expenses')) {
  const apiCode = `
// --- Expenses Management ---
...
// 2. Create ExpenseManagementModule.tsx
...
`;
fs.writeFileSync('frontend/src/components/admin/ExpenseManagementModule.tsx', moduleCode, 'utf8');

// 3. Inject into Admin page.tsx
let pagePath = 'frontend/src/app/admin/[[...slug]]/page.tsx';
let pageContent = fs.readFileSync(pagePath, 'utf8');

if (!pageContent.includes('ExpenseManagementModule')) {
  // Add import
...
console.log('Expense Management Module created and injected');
